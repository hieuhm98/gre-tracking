...
const DIFF_STYLE: Record<Difficulty, string> = {
  ...
  medium: "bg-amber-500/15 text-amber-300 border-amber-700/40",
  hard: "bg-rose-500/15 text-rose-300 border-rose-700/40",
};
...
function ExerciseCard({
  ...
  return (
    <div className="card">
      ...
      <h2 className="text-base font-semibold text-zinc-100">{pick(ex.title.vi, ex.title.en)}</h2>
      <p className="text-sm text-zinc-300 leading-relaxed mt-1.5">{pick(ex.prompt.vi, ex.prompt.en)}</p>
      ...
      <button
        ...
        className={cn(
          ...
          open
            ...
            : "bg-blue-600/15 text-blue-300 border-blue-800/50 hover:bg-blue-600/25"
        )}
      >
